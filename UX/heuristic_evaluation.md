...
* Dropbox 顯示「上傳失敗，檔案過大，請壓縮後重試」。
* 表單欄位旁標示具體錯誤訊息（如「密碼需8位以上」）。

---

## 10. 幫助與文件 (Help and documentation)

**意思**：當用戶需要深入幫助時，提供易取得的支援內容。
...
* Notion 提供詳細教學文件與影片，幫助用戶學習進階用法。
* Canva 新用戶可透過導覽學習如何建立第一個設計。

---

## ✅ 總結

Nielsen 十條啟發式原則不只是檢查清單，而是一套設計哲學：
...
透過詳細理解與實踐，每位設計師都能打造更直覺、高效、愉悅的數位產品。
